...
app.use(
  '/basic-test',
  express.static(path.join(__dirname, 'tests/basic-test'), {
    index: 'index.html',
  })
);
...
app.use(
  '/compute-test',
  express.static(path.join(__dirname, 'tests/compute-test'), {
    index: 'index.html',
  })
);
...
// Serve AI Mini Benchmark
app.use(
  '/ai-mini-benchmark',
  express.static(path.join(__dirname, 'tests/ai-mini-benchmark'), {
    index: 'index.html',
  })
);
app.use(
